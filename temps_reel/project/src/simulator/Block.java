...
public abstract class Block {
	...
	public double avancementTemps(Etat state) {
        return state.getTa();
    }
    ...
    public Boolean entreeImpactee(){
        ...
        for(Entree e : entrees){
            if(rtr == true && e.getFlag() == true)
            		rtr = true;
            else if(rtr == true && e.getFlag() == false)
        		rtr = true;
            else if(rtr == false && e.getFlag() == true)
            	rtr = true;
            else if(rtr == false && e.getFlag() == false)
            	rtr = false;
        }
        return rtr;
    }
